...
import RevisarCookiesPT from "@/components/buttons/RevisarCookiesPT";
...
export default function FooterPT() {
    ...
    const footerLinks = [
        ...
        { label: "Política de Privacidade", href: "/pt/politica-de-privacidade" },
        { label: "Termos de Uso", href: "/pt/termos-de-uso" },
        { label: "Política de Cookies", href: "/pt/politica-de-cookies" },
        { label: "Política de Afiliados", href: "/pt/politica-de-afiliados" }
    ];
