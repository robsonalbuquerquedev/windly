...
export default function HeroSplitAnimatedEN() {
    return (
        <section className="relative w-full min-h-[80vh] flex items-center justify-center overflow-hidden px-6 py-20">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                >
                    ...
                    >
                        Learn Tailwind, SEO and Semantics with the power of
                    ...
                    >
                        Build elegant, fast and professional interfaces using Next.js and modern best practices.
                    </motion.p>
