...
export default function Cookies() {
    ...
    // Estados de cookies individuais
    ...
    useEffect(() => {
        // Verifica escolha inicial
        const consent = localStorage.getItem("windly-consent");
        if (!consent) {
            setOpen(true);
        }

        // Ouvinte para reabrir o painel quando chamado externamente
    ...
    // Função para enviar consentimento ao Google
    ...
    return (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-[9999] px-4">
            <div className="bg-white max-w-lg w-full rounded-2xl p-6 shadow-xl border border-gray-200 space-y-4">
                ...
                {!customOpen && (
                    <>
                        <h2 className="text-xl font-semibold text-gray-800">Gerenciar Cookies</h2>
                        <p className="text-gray-600">
                            Usamos cookies para melhorar sua experiência. Escolha como deseja que seus dados sejam utilizados.
                        </p>
                ...
                {customOpen && (
                    <>
                        <h2 className="text-xl font-semibold text-gray-800">Preferências Personalizadas</h2>
