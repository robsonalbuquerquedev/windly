...
const institutionalRoutes = [
    ...
    { label: "Sobre", href: "/pt/sobre", icon: Info },
    { label: "Contato", href: "/pt/contato", icon: Mail },
];

// 🔹 Rotas de conteúdo extra (curadoria)
const contentExtraRoutes = [
    { label: "Meus Favoritos", href: "/pt/meus-favoritos", icon: Heart },
    { label: "Amantes da Leitura", href: "/pt/amantes-da-leitura", icon: Library },
];

// 🔹 Guias & Tutoriais
const prefix = "/pt/guias-tutoriais/";
    ...
    return (
        <nav aria-label="Menu principal" className="flex items-center gap-6">
            ...
            <div className="hidden md:flex items-center gap-6 text-sm">
                ...
                {/* 🔹 Link sozinho: Início */}
                <Link href="/" className={isActive("/pt")}>
